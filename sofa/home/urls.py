...
urlpatterns = [
    ...
    path('edit_address/<int:user_id>/<int:address_id>/',views.edit_address, name='edit_address'),
    path('delete_address/<int:user_id>/<int:address_id>/', views.delete_address, name='delete_address'),
